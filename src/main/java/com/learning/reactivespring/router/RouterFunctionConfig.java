    ...
    public RouterFunction<ServerResponse> routeFlux(SampleHandlerFunction sampleHandlerFunction){
        return RouterFunctions
                .route(GET("/functional/flux")
                        ...
                        ,sampleHandlerFunction::handlerRequestFlux
                )
                .andRoute(GET("/functional/mono")
                                .and(accept(MediaType.APPLICATION_JSON))
                        ,sampleHandlerFunction::handlerRequestMono);
    }

    /*@Bean
    public RouterFunction<ServerResponse> routeMono(SampleHandlerFunction sampleHandlerFunction){
        return RouterFunctions
